...
{{-- 	<div style="margin-top: ">
	...
	<font face="Arial" color="black"> <p align="center"> <u> <b> Laporan Report</b></u> <br/> Tanggal : {{ \Carbon\Carbon::now()->format('d-M-Y') }}</font>
	 ...
	 <table border="1"  cellspacing="0" cellpadding="3">
	 	<thead>
	 		<tr style="background-color: green">
	 			...
	 			<th style="text-align:center; color: white; width: 10%">Keterangan</th>
